...
This mechanism has been integrated into Bitcore-Node-Vice which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vice/insight-api-vice#web-socket-api](https://github.com/vice/insight-api-vice#web-socket-api)
* API: [https://github.com/vice/insight-api-vice#swifttx-transactions](https://github.com/vice/insight-api-vice#swifttx-transactions)
...
By default, the Vice Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vice Core daemon:
