...
In order to support loading of multiple wallets in vice-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vice.cpp.
...
Changes to vice.cpp
----------------------
vice.cpp is the entry point into vice-qt, and as such, will require some minor modifications to provide hooks for
