Contributing to Vice Core
==================================

The Vice Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vice Core project, and is not to be
confused with overall Vice Network Protocol consensus changes.

Whether a pull request is merged into Vice Core rests with the project merge
...
Patches that change Vice consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vice consensus, it must have been
...
The project leader is the release manager for each Vice Core release.
