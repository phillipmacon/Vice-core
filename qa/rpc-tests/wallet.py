...
#   c) node1 mines 32 blocks, so now node 0 has 500000VICE, node 1 has 4250VICE, node2 has none.
#   d) node0 sends 601 VICE to node2, in two transactions (301 VICE, then 300 VICE).
