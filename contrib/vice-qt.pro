...
RESOURCES += src/qt/vice.qrc src/qt/vice_locale.qrc

TRANSLATIONS += src/qt/locale/vice_bg.ts \
                src/qt/locale/vice_de.ts \
                src/qt/locale/vice_en.ts \
                src/qt/locale/vice_es.ts \
                src/qt/locale/vice_fi.ts \
                src/qt/locale/vice_fr.ts \
                src/qt/locale/vice_it.ts \
                src/qt/locale/vice_ja.ts \
                src/qt/locale/vice_pl.ts \
                src/qt/locale/vice_pt.ts \
                src/qt/locale/vice_ru.ts \
                src/qt/locale/vice_sk.ts \
                src/qt/locale/vice_sv.ts \
                src/qt/locale/vice_vi.ts \
                src/qt/locale/vice_zh_CN.ts \
                src/qt/locale/vice_zh_TW.ts
