...
/* Vice GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Vice"
#define QAPP_ORG_DOMAIN "viceplatform.org"
#define QAPP_APP_NAME_DEFAULT "Vice-Qt"
#define QAPP_APP_NAME_TESTNET "Vice-Qt-testnet"
