...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vice features */
        {"vice", "masternode", &masternode, true, true, false},
        {"vice", "listmasternodes", &listmasternodes, true, true, false},
        {"vice", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vice", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vice", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vice", "masternodedebug", &masternodedebug, true, true, false},
        {"vice", "startmasternode", &startmasternode, true, true, false},
        {"vice", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vice", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vice", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vice", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vice", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vice", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vice", "mnbudget", &mnbudget, true, true, false},
        {"vice", "preparebudget", &preparebudget, true, true, false},
        {"vice", "submitbudget", &submitbudget, true, true, false},
        {"vice", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vice", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vice", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vice", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vice", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vice", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vice", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vice", "checkbudgets", &checkbudgets, true, true, false},
        {"vice", "mnsync", &mnsync, true, true, false},
        {"vice", "spork", &spork, true, true, false},
        {"vice", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"vice", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"vice", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"vice", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"vice", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"vice", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> vice-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8932/\n";
}
