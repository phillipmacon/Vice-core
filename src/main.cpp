...
#if defined(NDEBUG)
#error "Vice cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uvice) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) 
        ...
        nSubsidy = 1000 * COIN;
    else if (nHeight >= 201 && nHeight <= 5000)
        nSubsidy = 1 * COIN;
